About inject-markdown-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/inject-markdown-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/inject-markdown-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add inject-markdown
# for installing globally
pixi global install inject-markdown
```
...
It is possible to list all of the versions of `inject-markdown` available on your platform:
...
```
pixi search inject-markdown --channel conda-forge
```
